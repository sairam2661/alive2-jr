...
// an opcode for ASLP is four bytes (= 32 bits), in Arm's conventional
// little-endian order.  Defined here (rather than in aslp_bridge.h) so
// that non-ASLP builds can still reference the type.
